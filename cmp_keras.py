...
if __name__ == '__main__':
  ...
  y = np.sin(X.sum(axis=1)**3 + 1)[:,np.newaxis]
  ...
  model.fit(X, y, loss=util.MSE(), optimizer=util.SGD(1.1, 0), n_epoch=150, batch_size=10)
  ...
  model1.fit(X, y, nb_epoch=150, batch_size=10)
